...
ggplot(love_2019, aes(x = type, y = n, fill = type)) +
  ...
  labs(title = "Netflix Movies vs TV Shows Containing 'Christmas' Added in 2019", 
       x = "Type", y = "Count")
```
The bar graph shows whether more movies or TV shows with "Christmas" in the title were released in 2020, the year with the most releases with "Christmas" in the title on Netflix. From the graph we can see that 25 of the releases were movies and 5 were TV shows, indicating that Netflix 5x more movies than tv shows with the word "Christmas" in the title in that year.
